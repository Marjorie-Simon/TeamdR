...
ActiveRecord::Schema.define(version: 2021_03_02_120325) do
  ...
  create_table "ratings", force: :cascade do |t|
    t.bigint "daily_status_id", null: false
    t.integer "value_stars"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["daily_status_id"], name: "index_ratings_on_daily_status_id"
  end
